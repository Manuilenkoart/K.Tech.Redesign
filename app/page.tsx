            ...
            >
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-lg text-slate-600 leading-relaxed">
                  <p>
                    <strong className="text-slate-800">KyivstarTech</strong> —
                    українська ІТ-компанія, яка створює високоякісні
                    технологічні продукти та рішення для бізнесу.
                  </p>
                  <p>
                    Досвід роботи з клієнтською базою у 25 мільйонів абонентів і
                    тисячами компаній дає нам змогу поєднувати експертизу в
                    повному циклі — від UX і продуктового підходу до управління
                    вендорами та розробки власної інфраструктури. Наші рішення
                    допомагають бізнесам масштабуватися, впроваджувати інновації
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Структурований підхід до розробки з використанням сучасних
              методологій та власних інструментів
            </p>
          </motion.div>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Ми поєднуємо технологічну досконалість з глибоким розумінням
              потреб українського ринку
            </p>
          </motion.div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-blue-50 via-white to-purple-50/30">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Простий та прозорий процес найму, який допоможе вам приєднатися до
              нашої команди
            </p>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-3xl p-8 md:p-12 text-white">
              ...
              <p className="text-lg text-yellow-100 mb-8 max-w-2xl mx-auto">
                Ми завжди шукаємо талановитих людей, які хочуть створювати
                майбутнє разом з нами
              </p>
